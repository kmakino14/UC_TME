...
paste0("Reproducibility/Results/Plots/Slide-tags/Figure3H.pdf") %>% pdf(.,h=4,w=5)
 plots
dev.off()
...
paste0("Reproducibility/Results/Plots/Slide-tags/FigureS5F_signature_scores.pdf") %>% pdf(.,h=4,w=5)
 plots
dev.off()
...
paste0("Reproducibility/Results/Plots/Slide-tags/FigureS5F_RNA.pdf") %>% pdf(.,h=8,w=5)
 plot(p1/p2)
dev.off()
...
paste0('Reproducibility/Results/Plots/Slide-tags/Figure3I.pdf') %>% pdf(.,h=4,w=5)
 plots
dev.off()


#################################################
# Fig.3J　Beeswarm plots of eRegulons
#################################################
...
paste0('Reproducibility/Results/Plots/Slide-tags/Figure3J.pdf') %>% pdf_3(w=5, h=3.5)
 plots
dev.off()

#################################################
# Fig.3C  Scatter plot of TF expression/activity
#################################################
...
paste0('Reproducibility/Results/Plots/Slide-tags/Figure3C.pdf') %>% pdf_3(w=3, h=3)
  p
dev.off()


#################################################
# Fig.3G/S5G　Co-occurence heatmap
#################################################
# P02
...
path_pheatmap = paste0("Reproducibility/Results/Plots/Slide-tags/Figure3G.pdf")
...
path_pheatmap = paste0("Reproducibility/Results/Plots/Slide-tags/FigureS5G.pdf")
col = colorRampPalette(col_list)
col_fun <- colorRamp2(seq(-1, 1, length.out = 50), col(50))
