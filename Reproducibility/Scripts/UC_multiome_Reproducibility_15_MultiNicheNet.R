...
paste0("Reproducibility/Results/Plots/BCG/FigureS10E.pdf") %>% pdf(., w=15,h=18)
 plot_oi
dev.off()
...
paste0("Reproducibility/Results/Plots/BCG/Figure5H.pdf") %>% pdf(., w=15,h=8)
 combined_plot
dev.off()
...
paste0("Reproducibility/Results/Plots/BCG/Figure5I.pdf") %>% pdf(., w=30,h=12)
 network_graph$plot
dev.off()