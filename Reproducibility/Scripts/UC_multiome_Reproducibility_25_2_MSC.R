...
#################################################
# Fig.4B  Module violin plot & heatmap
#################################################
# Heatmap
...
ggsave("Reproducibility/Results/Plots/MSC/Figure4B.pdf", plot = final_combined_figure, width = 15, height = 10)


#################################################
# Fig.S6B  Module corrplot
#################################################
...
paste0("Reproducibility/Results/Plots/MSC/FigureS6B.pdf") %>% pdf(.,width = 5, height = 5)
 p  
dev.off()


#################################################
# Fig.4G  Milo beeswarm plot
#################################################
...
paste0("Reproducibility/Results/Plots/MSC/Figure4G.pdf") %>% pdf(.,width = 7, height = 3.5)
 p  
dev.off()


#################################################
# Fig.4H  TF activity rank plot
#################################################
# 1) matCAF
...
pdf('Reproducibility/Results/Plots/MSC/Figure4H_matCAF.pdf', width = 5, height = 3)
 print(p1)
dev.off()
...
pdf('Reproducibility/Results/Plots/MSC/Figure4H_matCAP.pdf', width = 5, height = 3)
 print(p2)
dev.off()


#########################################################
## Fig.4I/S6E  Gene track with co-accessible regions
#########################################################
source("Reproducibility/Scripts/Source/Seurat_source.R")
...
Plot_genetrack(Obj=DOGMA,group.by='celltype',lineage='MSC',group_list=celltype_list,gene='COL3A1',
               ...
               path='Reproducibility/Results/Plots/MSC/Figure4I_COL3A1.pdf')

Plot_genetrack(Obj=DOGMA,group.by='celltype',lineage='MSC',group_list=celltype_list,gene='COL5A2',
               region_list=region_list, motif_list=motif_list,cutoff=0.3,cols=cols,
               path='Reproducibility/Results/Plots/MSC/Figure4I_COL5A2.pdf')
...
Plot_genetrack(Obj=DOGMA,group.by='celltype',lineage='MSC',group_list=celltype_list,gene='CXCL14',
               ...
               path='Reproducibility/Results/Plots/MSC/FigureS6E_CXCL14.pdf')
...
Plot_genetrack(Obj=DOGMA,group.by='celltype',lineage='MSC',group_list=celltype_list,gene='CD34',
               ...
               path='Reproducibility/Results/Plots/MSC/FigureS6E_CD34.pdf')


#########################################################
## Fig.S6F  proCAF Kaplan-Meier
#########################################################
...
paste0('Reproducibility/Results/Plots/MSC/FigureS6F.pdf') %>% pdf_3(., w = 6, h = 6)
  print(p1)
dev.off()
