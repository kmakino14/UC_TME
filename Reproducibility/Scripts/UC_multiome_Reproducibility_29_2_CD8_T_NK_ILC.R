...
paste0("Reproducibility/Results/Plots/CD8_T_NK_ILC/FigureS8D.pdf") %>% pdf(.,width = 18, height = 6)
 p1+p2
dev.off()


#################################################
# Fig.4J  CD8 fate probability
#################################################
...
paste0("Reproducibility/Results/Plots/CD8_T_NK_ILC/Figure4J_fate_prob_UMAP.pdf") %>% pdf(w=3, h=5)
 plot(p)
dev.off()


#########################################################
## Fig.S8H/S9E  Gene track with co-accessible regions
#########################################################
...
Plot_genetrack(Obj=DOGMA,lineage='CD8_T_NK_ILC',celltype_list=celltype_keep,gene='CTLA4',
               ...
               path='Reproducibility/Results/Plots/CD8_T_NK_ILC/FIgureS8H_CTLA4.pdf')
...
Plot_genetrack(Obj=DOGMA,lineage='CD8_T_NK_ILC',celltype_list=celltype_keep,gene='LAYN',
               ...
               path='Reproducibility/Results/Plots/CD8_T_NK_ILC/FIgureS8H_LAYN.pdf')
...
Plot_genetrack(Obj=DOGMA,lineage='CD8_T_NK_ILC',celltype_list=celltype_keep,gene='KLRC1',
               region_list=region_list, motif_list=motif_list,cutoff=0.2,cols=cols,
               path='Reproducibility/Results/Plots/CD8_T_NK_ILC/FIgureS9E_KLRC1.pdf')

Plot_genetrack(Obj=DOGMA,lineage='CD8_T_NK_ILC',celltype_list=celltype_keep,gene='ITGAE',
               region_list=region_list, motif_list=motif_list,cutoff=0.2,cols=cols,
               path='Reproducibility/Results/Plots/CD8_T_NK_ILC/FIgureS9E_ITGAE.pdf')


#########################################################
## Fig.S9B  Functional gene heatmap
#########################################################
...
paste0('Reproducibility/Results/Plots/CD8_T_NK_ILC/FIgureS9B.pdf') %>% pdf(.,width = 13, height = 2)
 draw(ht1+ht2+ht3+ht4+ht5+ht6+ht7+ht8+ht9+ht10)
dev.off()


#########################################################
## Fig.4K  in silico perturbation module heatmap
#########################################################
...
pdf('Reproducibility/Results/Plots/CD8_T_NK_ILC/Figure4K_ht1.pdf', width = 8, height = 8)
 ht
dev.off()
...
pdf('Reproducibility/Results/Plots/CD8_T_NK_ILC/Figure4K_ht2.pdf', width = 8, height = 8)
 ht2
dev.off()
...
pdf('Reproducibility/Results/Plots/CD8_T_NK_ILC/Figure4K_ht3.pdf', width = 8, height = 8)
 ht3
dev.off()


#########################################################
## Fig.4L  TF-gene program alluvium
#########################################################
...
pdf('Reproducibility/Results/Plots/CD8_T_NK_ILC/FIgure4L.pdf', width = 8, height = 8)
 p
dev.off()


#########################################################
## Fig.S9G Violin plot of CD8 GPs in NK cells
#########################################################
...
pdf_3('Reproducibility/Results/Plots/CD8_T_NK_ILC/FIgureS9G.pdf', h = 4, w = 7)
 plot(p)
dev.off()


#########################################################
## Fig.S9H Box plot of NK cells fraction
#########################################################
...
paste0('Reproducibility/Results/Plots/CD8_T_NK_ILC/FIgureS9H.pdf') %>% pdf_3(., w=12, h=5)
 plot(p)
dev.off()
