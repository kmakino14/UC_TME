...
#################################################
# Fig.6B  Bar plot of differential genes/peaks
#################################################
# RNA
...
paste0("Reproducibility/Results/Plots/BCG/Figure6B_barplot_DEG_counts.pdf")%>% pdf(., w = 3.5, h = 5)
...
paste0("Reproducibility/Results/Plots/BCG/Figure6B_barplot_DA_counts.pdf")%>% pdf(., w = 3.5, h = 5)
...
#################################################
# Fig.6C  Differential volcano plot
#################################################
...
paste0("Reproducibility/Results/Plots/BCG/Figure6C_volcano_CD4_Tconv.pdf") %>% pdf(.,width=3,height=3)
...
paste0("Reproducibility/Results/Plots/BCG/Figure6C_volcano_Mono_Mac.pdf") %>% pdf(.,width=3,height=3)
...
paste0("Reproducibility/Results/Plots/BCG/Figure6C_barplot_CD4_Tconv.pdf") %>% pdf(.,h=5,w=15)
 plot(p1)
dev.off()  
...
paste0("Reproducibility/Results/Plots/BCG/Figure6C_barplot_Mono_Mac.pdf") %>% pdf(.,h=5,w=15)
 plot(p2)
dev.off()


#################################################
# Fig.6F  Violin plot of signature scores
#################################################
...
pdf_3("Reproducibility/Results/Plots/BCG/Figure6F.pdf", h = 4, w = 9)
 plot(p)
dev.off()


#################################################
# Fig.6D  Milo beeswarm plot
#################################################
...
paste0("Reproducibility/Results/Plots/BCG/Figure6D.pdf") %>% pdf(.,width=11,height=12)
 plot(p)
dev.off()


#################################################
# Fig.S12B  DPP4/IFNG/CD26 expression
#################################################
Idents(DOGMA) = "sample"
...
paste0("Reproducibility/Results/Plots/BCG/FigureS12B.pdf") %>% pdf(., w=7, h=4)
 plot(p)
dev.off()


#################################################
# Fig.S12D  CD4_T_CD26 volcano plot
#################################################
...
paste0("Reproducibility/Results/Plots/BCG/FigureS12D.pdf") %>% pdf(.,width=3,height=3)
...
paste0("Reproducibility/Results/Plots/BCG/FigureS12C.pdf") %>% pdf(,width = 12, height = 6)
 plots
dev.off()


#################################################
# Fig.6I  Scatter plot of TF expression/activity
#################################################
# CD4_Tconv
...
paste0("Reproducibility/Results/Plots/BCG/Figure6I.pdf") %>% pdf(., w=7, h=3.5)
 plot(p|q)
dev.off()

#################################################
# Fig.S12F  Violin plot of TF activity
#################################################
# CD4_T
...
paste0("Reproducibility/Results/Plots/BCG/FigureS12F_CD4_Tconv.pdf") %>% pdf_3(.,h=3.5,w=7)
 plot(p)
dev.off()
...
paste0("Reproducibility/Results/Plots/BCG/FigureS12F_Mono_Mac.pdf") %>% pdf_3(.,h=3.5,w=7)
 plot(p)
dev.off()


#########################################################
## Fig.S12G/H  Gene track with co-accessible regions
#########################################################
source("Reproducibility/Scripts/Source/Seurat_source.R")
...
Plot_genetrack_BCG(Obj=CD4_Tconv,lineage='CD4_T',group_list=c('pre','post'),gene='CCL20',
               ...
               path='Reproducibility/Results/Plots/BCG/FigureS12G_CCL20.pdf')
...
Plot_genetrack_BCG(Obj=CD4_Tconv,lineage='CD4_T',group_list=c('pre','post'),gene='DPP4',
               ...
               path='Reproducibility/Results/Plots/BCG/FigureS12G_DPP4.pdf')
...
Plot_genetrack_BCG(Obj=Mono_Mac,lineage='Myeloid',group_list=c('pre','post'),gene='CXCL9',
               region_list=region_list, motif_list=motif_list,cutoff=0.1,cols=cols,
               path='Reproducibility/Results/Plots/BCG/FigureS12H_CXCL9.pdf')

Plot_genetrack_BCG(Obj=Mono_Mac,lineage='Myeloid',group_list=c('pre','post'),gene='CXCL10',
               region_list=region_list, motif_list=motif_list,cutoff=0.1,cols=cols,
               path='Reproducibility/Results/Plots/BCG/FigureS12H_CXCL10.pdf')
