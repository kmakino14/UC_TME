...
paste0("Reproducibility/Results/Plots/B/FigureS8B.pdf") %>% pdf_3(.,w = 14, h = 4)
 p1+p2
dev.off()


#################################################
# Fig.S8C  Proportion box plot
#################################################
...
paste0("Reproducibility/Results/Plots/B/FigureS8C.pdf") %>% pdf_3(.,w = 14, h = 4)
 p
dev.off()

#################################################
# Fig.S8E  eRegulon heatmap
#################################################
...
ggsave(filename = "Reproducibility/Results/Plots/B/FigureS8E.pdf", plot = base_plot, width = 15, height = 7)
